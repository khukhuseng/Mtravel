...
export default class Tnc_TourPackage extends Component<Props> {
        ...
        return (
            <Container style={Styles.container}>
                ...
                <View style={Styles.center}>
                    ...
                    <View ><Text style={{ fontWeight: 'bold', fontSize: 20 }}>(Tour Packages T&C)</Text></View>
                </View>
                <WebView
                    source={{ uri: `https://h5-app.mtravelclub.com/term/term-excursion.php` }}
                />
            </Container>
        );
    }
