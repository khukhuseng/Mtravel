...
export default class Tnc_Lifestyle extends Component<Props> {
        ...
        return (
            <Container style={Styles.container}>
                ...
                <View style={Styles.center}>
                    ...
                    <View ><Text style={{ fontWeight: 'bold', fontSize: 20 }}>(Lifestyle)</Text></View>
                </View>
                <WebView
                    source={{ uri: `https://h5-app.mtravelclub.com/term/term-lifestyle.php` }}
                />
            </Container>
        );
    }
